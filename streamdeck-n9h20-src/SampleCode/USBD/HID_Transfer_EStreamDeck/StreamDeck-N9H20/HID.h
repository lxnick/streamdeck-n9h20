...
#define USBD_MAX_POWER 0xFA // Eden /* The unit is in 2mA. ex: 50 * 2mA = 100mA */
...
#define EPB_MAX_PKT_SIZE 1024 // Eden
...
#define ICON_BUFFER_NUM 80
#define ICON_BUFFER_SIZE 1024 * 12

    extern UINT8 icon_index;
